...
Recorder::Recorder(int width, int height, float frameRate) : width(width), height(height), framebuffer(new unsigned char[width * height * 3]), fps(static_cast<int>(frameRate)) {
    InitializeFBO();
